...
system(f'docker run --rm -m 32g -e config_file="{module}/config.json" -e archive_path="{module}/run4" -v "{prefix}/Shared drives/NIAAA_ASSIST/Data":/assist/Data assist/{module}:0.1.0')
print(f"{datetime.now()}")