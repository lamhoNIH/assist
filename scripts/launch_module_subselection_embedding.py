...
system(f'docker run --rm -m 40g -e config_file="Data/{output_path}/config.json" -e archive_path="Data/{output_path}" -e run_num="run1" -v "{data}":/assist/Data assist/{module}:0.1.0')
print(f"{datetime.now()}")