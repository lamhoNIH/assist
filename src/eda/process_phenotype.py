...
def get_liver_class(expression_meta = expression_meta):
    expression_meta_w_liver_class = expression_meta[~expression_meta['Liver_class'].isna()]
    return expression_meta_w_liver_class

def get_expression_by_alcohol_perday(expression_meta = expression_meta):
...
def get_expression_by_drinking_yrs(expression_meta = expression_meta):
...
def get_smoke_freq(expression_meta = expression_meta):
